#ifndef AliHFInvMassFittert_H
#define AliHFInvMassFittert_H
...
/////////////////////////////////////////////////////////////
///
/// \class AliHFInvMassFittert
/// \brief AliHFInvMassFittert class for the fit of
...
class AliHFInvMassFittert : public TNamed {
 public:

  enum ETypeOfBkg{ kExpo=0, kLin=1, kPol2=2, kNoBk=3, kPow=4, kPowEx=5};
  enum ETypeOfSgn{ kGaus=0, k2Gaus=1, k2GausSigmaRatioPar=2 };
  AliHFInvMassFittert();
  AliHFInvMassFittert(const TH1F* histoToFit, Double_t minvalue, Double_t maxvalue, Int_t fittypeb=kExpo, Int_t fittypes=kGaus);
  ~AliHFInvMassFittert();
  ...
  void DrawHere1(TVirtualPad* c, Double_t nsigma=3,Int_t writeFitInfo=2);
 ...
 private:
  AliHFInvMassFittert(const AliHFInvMassFittert &source);
  AliHFInvMassFittert& operator=(const AliHFInvMassFittert& source);
  ...
  /// \cond CLASSIMP     
  ClassDef(AliHFInvMassFittert,9); /// class for invariant mass fit
  /// \endcond
};
